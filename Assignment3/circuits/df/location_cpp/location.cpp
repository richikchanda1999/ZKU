...
#include "circom.hpp"
#include "calcwit.hpp"
void getAreaOfTraingle_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void getAreaOfTraingle_0_run(uint ctx_index,Circom_CalcWit* ctx);
...
void isValid_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void isValid_5_run(uint ctx_index,Circom_CalcWit* ctx);
void verify_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void verify_6_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 287;}

uint get_number_of_components() {return 13;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 224;}
...
ctx->componentMemory[coffset].templateName = "getAreaOfTraingle";
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 6]); // line circom 16
// end load src
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 4]); // line circom 18
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 8]); // line circom 20
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 2]); // line circom 23
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 6]); // line circom 25
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 11]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 4]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 2]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 13],&signalValues[mySignalStart + 14]); // line circom 34
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 12]); // line circom 37
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 16],&signalValues[mySignalStart + 15]); // line circom 39
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 101],&lvar[3]); // line circom 32
...
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 101]); // line circom 38
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 100]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
ctx->componentMemory[coffset].templateName = "isValid";
ctx->componentMemory[coffset].signalStart = soffset;
...
// load src
Fr_pow(&expaux[0],&signalValues[mySignalStart + 5],&circuitConstants[5]); // line circom 53
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 8];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 4]); // line circom 58
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 9];
// load src
Fr_pow(&expaux[0],&signalValues[mySignalStart + 7],&circuitConstants[5]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 10];
// load src
Fr_pow(&expaux[0],&signalValues[mySignalStart + 8],&circuitConstants[5]); // line circom 64
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 11];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 10]); // line circom 67
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 12];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 11],&signalValues[mySignalStart + 6]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&circuitConstants[1],&signalValues[mySignalStart + 1]); // line circom 86
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 89
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 6];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 3]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 7];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 6],&circuitConstants[6]); // line circom 95
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "calcArea";
mySubcomponents[aux_create+i] = aux_cmp_num;
getAreaOfTraingle_0_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 18 ;
aux_cmp_num += 1;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "validMove1";
mySubcomponents[aux_create+i] = aux_cmp_num;
isValid_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 121 ;
aux_cmp_num += 4;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "validMove2";
mySubcomponents[aux_create+i] = aux_cmp_num;
isValid_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 121 ;
aux_cmp_num += 4;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "finalComp";
mySubcomponents[aux_create+i] = aux_cmp_num;
verify_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 11 ;
aux_cmp_num += 2;
}
}
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
getAreaOfTraingle_0_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 11];
// load src
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
isValid_5_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
verify_6_run(mySubcomponents[cmp_index_ref],ctx);
}
{
